...
export default function CreateDishPage() {
  ...
  // Load previously selected ingredients from localStorage when returning from the-pass
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-neutral-950">
      ...
      <div className="bg-gradient-to-b from-neutral-950 via-neutral-900 to-black">
        {/* Ingredients Section Header - Ultra Mobile Responsive */}
      ...
      <div className="container mx-auto px-2 sm:px-4 md:px-6 py-6 sm:py-8 md:py-12">
        <IngredientList 
          ...
          onDroppedIngredientsChange={(tickers) => {
            // Sync drag-and-drop selections with click-based selections
            console.log('🔄 Syncing dropped ingredients to page state:', tickers);
            setSelectedIngredients(tickers);
          }}
        />
      </div>
        ...
        <div className="fixed bottom-0 sm:bottom-8 left-0 sm:left-1/2 sm:-translate-x-1/2 w-full sm:w-auto sm:max-w-3xl bg-neutral-900 border-t-2 sm:border-2 border-emerald-500/50 sm:rounded-2xl p-3 sm:p-4 shadow-2xl z-40">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
            ...
            <button 
              ...
              onClick={() => {
                // Save selected ingredients and navigate directly to the-pass
